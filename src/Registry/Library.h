...
namespace Registry
{
    class Library : public Singleton<Library>
    {
        ...
        static constexpr const char* CUM_FX_CONFIG_PATH{ "Data\\Textures\\SexLab\\CumFx\\Configs\\" };
      ...
      public:
        ...
        struct FxConfig
        {
            ...
            std::array<std::vector<FxProfile>, NUM_FX_TYPES> profiles;
        };
