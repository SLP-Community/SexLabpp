...
Function EnjoymentSettings()
	...
	AddStateOptionSlider("fEnjRaiseMultInter", "$SSL_fEnjRaiseMultInter", 0.8, 0, 3, 0.1, "{1}", enj_flag)	
	...
	AddStateOptionSlider("iNoPainRequiredTime", "$SSL_iNoPainRequiredTime", 30, 0, 180, 10, "{0}", enj_flag)
